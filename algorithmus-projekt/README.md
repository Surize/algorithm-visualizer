...
- No file exceeds 150 lines. The largest is the JS renderer (~140).
- All algorithms implemented by hand — no `sorted()` shortcuts.
- The `StepLogger` abstraction means adding a "Cocktail Sort" or "Shell Sort" is roughly 20 lines + 1 registration.
